            ...
            <div key={item.id} className="bg-card border border-border rounded-lg p-4 hover:shadow-md transition-shadow">
              <div className="relative">
                <img 
                  src={item.image} 
                  alt={item.name}
                  className="w-full h-48 object-cover rounded-md bg-accent/30"
                />
                {item.onSale && (
                ...
                <button
                  ...
                  className="absolute top-2 right-2 p-2 bg-background rounded-full shadow-md hover:bg-accent transition-colors"
                >
